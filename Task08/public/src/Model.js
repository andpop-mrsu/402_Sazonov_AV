import { redrawCell,
 drawField,
  changeGameButtonPicture,
   drawNumberInCell,
    deleteFlag
    , drawGamesInfoTable,
     drawConcreteGameTable 
 } from './View.js';

var gameField = document.getElementById("gameField");
var infoField = document.getElementById("gameInfo");
var gameButton = document.getElementById('gameButton');

var user, cells, bombsArray;
var openCount, lostGame, wonGame;
var flagCount, bombs, turnNumber;
